 ...
 */
export async function initASMAAppVitals({ onChangeAuthenticated, is_child_app = false, subdomain_check, setLoadMicroApp, registerOpenReplay, }) {
    /**
     * !!!ORDER IMPORTANT!!!
    ...
    await (registerOpenReplay === null || registerOpenReplay === void 0 ? void 0 : registerOpenReplay());
    if (!is_child_app) {
