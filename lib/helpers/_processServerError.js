export function _processServerError(error) {
    console['error'](error);
...
/* @__PURE__ */
export function _getServerErrorMessage(error) {
    var _a, _b, _c;
...
function _getArrayErrorsMessage(error) {
    const processed_error = error
        ...
        .join();
    return processed_error !== null && processed_error !== void 0 ? processed_error : 'No message field found! please check logs';
}
//# sourceMappingURL=_processServerError.js.map