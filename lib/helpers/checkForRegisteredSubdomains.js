...
export async function checkForRegisteredSubdomain({ redirect_if_not_exists = true, setSelectedCustomer, srvAuthGet, logos, authenticated, no_greenish_theme = false, }) {
