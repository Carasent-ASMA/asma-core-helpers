...
export function getConnectorInternal() {
    var _a, _b;
    const getConnector = (_b = (_a = window.__ASMA__SHELL__) === null || _a === void 0 ? void 0 : _a.auth_bindings) === null || _b === void 0 ? void 0 : _b.getConnector;
    if (!getConnector) {
        throw new Error('getCachedJwt is not defined! please make sure that generateSrvAuthBindings is called before getCachedJwt');
    }
    return getConnector();
...
logout) {
    ...
    function hasFeature(featureName) {
        ...
        const asmaDebug = localStorage.getItem('enable-all-features') === 'true';
        ...
        //     hasFeature = hasFeatureCheck
        // }
        return EnvConfigsFnInternal().DEVELOPMENT || asmaDebug || !!(features === null || features === void 0 ? void 0 : features.has(featureName));
    }
